...
/* broadcast/Like.stream.html.twig */
class __TwigTemplate_423c40af4055378de5a85986a6709588 extends Template
{
    ...
    protected function doDisplay(array $context, array $blocks = []): iterable
    {
        ...
        $__internal_5a27a8ba21ca79b61932376b2fa922d2->enter($__internal_5a27a8ba21ca79b61932376b2fa922d2_prof = new \Twig\Profiler\Profile($this->getTemplateName(), "template", "broadcast/Like.stream.html.twig"));

        $__internal_6f47bbe9983af81f1e7450e9a3e3768f = $this->extensions["Symfony\\Bridge\\Twig\\Extension\\ProfilerExtension"];
        $__internal_6f47bbe9983af81f1e7450e9a3e3768f->enter($__internal_6f47bbe9983af81f1e7450e9a3e3768f_prof = new \Twig\Profiler\Profile($this->getTemplateName(), "template", "broadcast/Like.stream.html.twig"));
...
";
    ...
    public function block_create(array $context, array $blocks = []): iterable
    {
        ...
        // line 3
        yield "    <turbo-stream action=\"append\" target=\"likes\">
        <template>
            <div id=\"";
        // line 5
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(("like_" . (isset($context["id"]) || array_key_exists("id", $context) ? $context["id"] : (function () { throw new RuntimeError('Variable "id" does not exist.', 5, $this->source); })())), "html", null, true);
        yield "\">
                #";
        // line 6
...
";
    ...
    public function block_update(array $context, array $blocks = []): iterable
    {
        ...
        // line 13
        yield "    <turbo-stream action=\"update\" target=\"like_";
...
";
    ...
    public function block_remove(array $context, array $blocks = []): iterable
    {
        ...
        // line 21
        yield "    <turbo-stream action=\"remove\" target=\"like_";
...
";
    ...
    {
        return "broadcast/Like.stream.html.twig";
    }
...
{% block create %}
    <turbo-stream action=\"append\" target=\"likes\">
        <template>
            <div id=\"{{ 'like_' ~ id }}\">
                #{{ id }} created
            </div>
...
{% block update %}
    <turbo-stream action=\"update\" target=\"like_{{ id }}\">
        <template>
            #{{ id }} updated
        </template>
    </turbo-stream>
...
{% block remove %}
    <turbo-stream action=\"remove\" target=\"like_{{ id }}\"></turbo-stream>
{% endblock %}
", "broadcast/Like.stream.html.twig", "C:\\Users\\Maxime\\PhpstormProjects\\mini-reseau-social-symfonyV2\\templates\\broadcast\\Like.stream.html.twig");
    }
}
